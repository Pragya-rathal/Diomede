...
def test_update_destination_works():
    destinations.clear()
    add_destination("dest1", {"host": "a", "port": 104})
    update_destination("dest1", {"host": "b", "ae": "x"})
